              ...
              <ul class="activity-participants">
                ${details.participants.map((participant) => `
                  <li class="participant-item">
                    <span class="profile-avatar">${participant.charAt(0).toUpperCase()}</span>
                    <span class="participant-email">${participant}</span>
                    <button class="unregister-button" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" title="Remove ${participant}">×</button>
                  </li>
                `).join("")}
              </ul>
            ` : `
